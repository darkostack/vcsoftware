...
#define VCRTOS_CONFIG_THREAD_EVENT_HIGHEST_STACK_SIZE 4096
#define VCRTOS_CONFIG_THREAD_EVENT_MEDIUM_STACK_SIZE 4096
#define VCRTOS_CONFIG_THREAD_EVENT_LOWEST_STACK_SIZE 4096
